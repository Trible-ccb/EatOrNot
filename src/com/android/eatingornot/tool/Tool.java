package com.android.eatingornot.tool;
...
public class Tool {
	...
	public static Bitmap getScaleImageByScaleOfWinWidth(Context c ,String pathName,float p){
...
//		Bitmap bmp = convertDrawable2BitmapByCanvas(d);
		...
		try {
			newBitMap = Bitmap.createBitmap(bmp, 0, 0, bmpW, bmpH, m, true);
		} catch (Exception e) {
			LogWorker.i("createBitmap Exception:" + e.getMessage());
			e.printStackTrace();
		}
